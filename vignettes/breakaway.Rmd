...
Interpretation: In this sample, there were `frequencytablelist[[63]][1,"Frequency"]` different species observed only once (singletons), `frequencytablelist[[63]][2,"Frequency"]` different species observed only twice, ..., 1 species observed `frequencytablelist[[63]][,"Index"] %>% tail(n = 1)` times.
